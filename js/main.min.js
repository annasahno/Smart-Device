...
/* harmony import */ var _modules_product_js__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./modules/product.js */ "./js/modules/product.js");
...
window.addEventListener('DOMContentLoaded', function () {
  ...
  Object(_modules_about_js__WEBPACK_IMPORTED_MODULE_4__["openMore"])();
  Object(_utils_remove_no_js_class_js__WEBPACK_IMPORTED_MODULE_1__["removeNoJsClass"])();
  Object(_modules_accordion_js__WEBPACK_IMPORTED_MODULE_3__["toggleAccordion"])();
  Object(_modules_product_js__WEBPACK_IMPORTED_MODULE_5__["changeText"])();
  Object(_modules_form_js__WEBPACK_IMPORTED_MODULE_6__["validateForm"])();
...
var openMore = function openMore() {
  if (section && toggle) {
    toggle.addEventListener('click', function () {
      ...
      blocksText.forEach(function (item) {
...
var toggleAccordion = function toggleAccordion() {
  document.querySelectorAll('[data-accordion-toggle]').forEach(function (item) {
    item.addEventListener('click', function () {
      var parent = item.parentNode;
      if (parent.classList.contains('is-open')) {
        parent.classList.remove('is-open');
      } else {
        document.querySelectorAll('.is-open').forEach(function (child) {
...
var getInputNumbers = function getInputNumbers(input) {
  return input.value.replace(/\D/g, '');
};
var onInput = function onInput(e) {
  var input = e.target;
  var inputNumbers = getInputNumbers(input);
  var formattedInputNumber = '';
...
var changeText = function changeText() {
  if (breakpoint.matches) {
    document.querySelectorAll('[data-phone-text]').forEach(function (item) {
